...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_ZN3O")

  // remove field
  collection.fields.removeById("_clone_zGgM")

  // remove field
  collection.fields.removeById("_clone_cBuI")

  // remove field
  collection.fields.removeById("_clone_0hil")

  // remove field
  collection.fields.removeById("_clone_i20P")

  // remove field
  collection.fields.removeById("_clone_EDFA")

  // remove field
  collection.fields.removeById("_clone_UMDI")

  // remove field
  collection.fields.removeById("_clone_OfAo")

  // remove field
  collection.fields.removeById("json1459818029")

  // remove field
  collection.fields.removeById("_clone_JIvg")

  // remove field
  collection.fields.removeById("_clone_6JKP")

  // remove field
  collection.fields.removeById("_clone_xfrQ")

  // remove field
  collection.fields.removeById("_clone_LtNu")

  // remove field
  collection.fields.removeById("_clone_cxJB")

  // remove field
  collection.fields.removeById("_clone_8BbE")

  // remove field
  collection.fields.removeById("_clone_7bQU")

  // remove field
  collection.fields.removeById("_clone_hUre")
